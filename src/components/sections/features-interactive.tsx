...
const features: Feature[] = [
{
  ...
  imageSrc: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/Untitled-design-3-1764765102567.png?width=8000&height=8000&resize=contain",
...
},
{
  ...
  imageSrc: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/Untitled-design-4-1764765102531.png?width=8000&height=8000&resize=contain",
...
},
{
  ...
  imageSrc: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/Untitled-design-5-1764765102892.png?width=8000&height=8000&resize=contain",
...
},
{
  ...
  imageSrc: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/Untitled-design-6-1764765102844.png?width=8000&height=8000&resize=contain",
  ...
  return (
    <section className="py-16 lg:py-24 px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
        <div className="relative mx-auto lg:mx-0 !w-[563px] !h-[500px]">
          <Image
            key={activeIndex}
            ...
            priority
            quality={95}
            className="max-w-[300px] mx-auto !w-[438px] !h-full lg:!max-w-[438px] mix-blend-darken" />
